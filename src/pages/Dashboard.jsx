...
import {
  ...
  UserPlus, CheckCircle, DollarSign, FileText, Folder
} from 'lucide-react';
import {
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Resumen general del sistema — Diciembre 2024</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
        ...
        <div className="card">
          ...
          <p className="text-gray-400 text-xs mt-2">Vencen en Diciembre 2024</p>
